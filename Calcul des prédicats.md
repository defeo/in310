...
La théorie de la preuve de la logique du premier ordre n'est pas plus compliquée que celle du [Calcul des propositions](Calcul des propositions): la définition de **vérité** est similaire, et les **systèmes de preuve** sont identiques (après ajout de quelques règles d'inférence).
