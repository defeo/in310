...
$$\mathrm{Im}\,f = \{b\in B | \exists a\in A.f(a)=b\}.$$
...
$$f(C) = \{b\in B | \exists c\in C.f(c)=b\}.$$
...
<img style="width:30%; display:inline-block" src="http://cnx.org/content/m15239/latest/f2.gif" alt="Graphe de la fonction identité sur les naturels."/>
<p style="margin-left:2ex; width:50%; display:inline-block">Cette image a été crée par Singh, S. (2007, October 26). Functions. Téléchargée du site [Connexions](http://cnx.org/content/m15239/1.8/).</p>
