Cet article traite de la récursion en tant qu'outil pour la définition d'objets mathématiques (en particulier de [fonctions](Fonction)). Pour la technique de preuve dite *par récurrence*, voir [Induction]().
